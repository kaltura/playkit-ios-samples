...
- (void)handleTracks {
    ...
    [self.player addObserver:self events:@[PlayerEvent.tracksAvailable, PlayerEvent.trackSelected] block:^(PKEvent * _Nonnull event) {
        ...
        } else if ([event isKindOfClass:PlayerEvent.trackSelected]) {
