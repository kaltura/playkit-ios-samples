 ...
 *  @param totalTime    the total duration of the ad being played
 */
...
/**
 *  @deprecated Replaced by videoDisplayDidPlay:
 */
- (void)onPlay DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplay:volumeChangedTo:
 */
- (void)onVolumeChangedToVolume:(float)volume DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplay:didProgressWithMediaTime:totalTime:
 */
- (void)onProgressWithMediaTime:(NSTimeInterval)mediaTime
                      totalTime:(NSTimeInterval)totalTime DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayDidClick:
 */
- (void)onClick DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayDidPause:
 */
- (void)onPause DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayDidResume:
 */
- (void)onResume DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayDidComplete:
 */
- (void)onComplete DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayDidReceiveError:
 */
- (void)onError DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayDidSkip:
 */
- (void)onSkip DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayDidShowSkip:
 */
- (void)onSkipShown DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayDidStart:
 */
- (void)onStart DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplay:didReceiveTimedMetadata:
 */
- (void)onTimedMetadata:(NSDictionary *)metadata DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayDidLoad:
 */
- (void)onLoaded DEPRECATED_ATTRIBUTE;
...
/**
 *  @deprecated Replaced by videoDisplay:didBufferToMediaTime:
 */
- (void)onBufferedWithMediaTime:(NSTimeInterval)mediaTime DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayIsPlaybackReady:
 */
- (void)onPlaybackReady DEPRECATED_ATTRIBUTE;

/**
 *  @deprecated Replaced by videoDisplayDidStartBuffering:
 */
- (void)onStartBuffering DEPRECATED_ATTRIBUTE;
